...
(function () {
  ...
  function css() {
    ...
    s.textContent = "" +
      ...
      "@media(max-width:640px){.ava-stats-box{line-height:1.2}.ava-stats-earned{margin-bottom:20px}.ava-stats-live{color:#ABA097}.ava-stats-live i{background:#ABA097}.ava-stats-kpis{flex-wrap:wrap}.ava-stats-kpi{flex:1 1 calc(33% - 10px);min-width:96px;padding:12px 12px}.ava-stats-kpi b{font-size:16px}.ava-stats-meta{flex-wrap:wrap;gap:14px 20px}.ava-stats-live{margin-left:0;width:100%;order:9}.ava-stats-bars{gap:4px}.ava-stats-col .v{font-size:9px}.ava-stats-col .m{font-size:9px}.ava-stats-earned .val{font-size:20px}}";
